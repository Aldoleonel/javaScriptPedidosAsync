        ...
        document.querySelector('.formulario').addEventListener('submit', async (event) => {
            ...
            try {
                ...
                if (updateResponse.ok) {
                    ...
                    // Podrías mostrar un mensaje o realizar alguna otra acción después de la actualización exitosa
                } else {
        ...
        document.querySelector('#deleteButton').addEventListener('click', async () => {
            try {
                ...
                if (deleteResponse.ok) {
                    ...
                    // Podrías mostrar un mensaje o realizar alguna otra acción después de la eliminación exitosa
                } else {
